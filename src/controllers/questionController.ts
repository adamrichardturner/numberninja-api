...
const rangeMapping: { [key: string]: number } = {
    "2fc48105-33cd-45bd-957b-850cde45c6e9": 10, // UUID for range 1-10
    "737c2b8d-81c1-491b-a9de-2dc9570793e1": 20, // UUID for range 1-20
    "7cb12fa0-0e35-4e64-9c0a-2a852363e81c": 100, // UUID for range 1-100
};

// Mapping from operation UUIDs to operation names
const operationMapping: { [key: string]: string } = {
    "679da447-9c0d-4c2f-b95e-aa2aa6d52342": "addition", // UUID for addition
    "739374c2-e5c9-4436-856e-2ca6c30e7c54": "subtraction", // UUID for subtraction
    "e69005d4-1617-41c4-bc4a-850369e0a9df": "multiplication", // UUID for multiplication
    "cc188a7b-8653-4a00-9267-be2623c238f8": "division", // UUID for division
};
...
export const getQuestions = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const questions = generateQuestions(
            sessionId,
            question_count, // Pass the correct question count here
            range, // Pass the mapped numeric range
            operation, // Pass the mapped operation name
        );
